...
#define IN_CODE_TABLE	{\
		...
		IN::P, IN::S, IN::Q, IN::S,  IN::T, IN::S, IN::S, IN::T,   IN::S, IN::S, IN::S, IN::S,  IN::S, IN::S, IN::T, IN::S,\
		...
		IN::T, IN::T, IN::T, IN::T,  IN::T, IN::T, IN::T, IN::T,   IN::T, IN::T, IN::T, IN::T,  IN::T, IN::T, IN::T, IN::T,\
		IN::T, IN::T, IN::T, IN::T,  IN::T, IN::T, IN::T, IN::T,   IN::T, IN::T, IN::T, IN::T,  IN::S, IN::T, IN::T, IN::T,\
																														   \
